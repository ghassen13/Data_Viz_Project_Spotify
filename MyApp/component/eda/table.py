...
class DataTable:
    def __init__(self, data):
        ...
        self.data_table = pn.widgets.Tabulator(self.filtered_data, height=500,sizing_mode='stretch_width', page_size=20)
...
# Table mch mrgl lezem les colonnes yodhohro mrglin mch dekhlin f baadhhom o k nenzel aala es wala haja table lkol yetbadel